...
{
    public class ComponentDescriptionCondition
    {
        ...
        public ComponentDescriptionCondition(ConditionType type, string name, ConditionComparison comparison, object compareTo)
        {
            Type = type;
            VariableName = name;
        ...
        public static ComponentDescriptionCondition Parse(string value)
        {
            ConditionType type;
            ...
            return new ComponentDescriptionCondition(type, variableName, comparisonType, compareTo);
        }

        public bool Met(Component component)
        {
            if (Type == ConditionType.State)
            {
