        ...
        public static IO.Data.CircuitDocument ToIOCircuitDocument(this IODocument document)
        {
            ...
            foreach (var c in document.Components)
            {
                ...
                var component = new IO.Data.PositionalComponent(type,
                    null,
                    new ElementLocation((int)c.Location.Value.X, (int)c.Location.Value.Y));

                component.Layout.Size = c.Size;
                component.Layout.IsFlipped = c.IsFlipped;
                if (c.Orientation.HasValue)
                    component.Layout.Orientation = c.Orientation == Orientation.Horizontal
            ...
            {
                var w = new Wire(new ElementLocation((int)wire.Location.X, (int)wire.Location.Y));

                w.Layout.Size = wire.Size;
                w.Layout.Orientation = wire.Orientation == Orientation.Horizontal
                    ? ComponentOrientation.Horizontal
                    : ComponentOrientation.Vertical;
