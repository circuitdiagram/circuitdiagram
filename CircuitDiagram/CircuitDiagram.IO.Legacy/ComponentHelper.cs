...
using ComponentProperty = CircuitDiagram.Components.Description.ComponentProperty;
    ...
    public static class ComponentHelper
    {
        ...
        public static bool IsStandardComponent(ComponentDescription componentDescription)
        {
            if (componentDescription.Metadata.GUID == Guid.Empty || componentDescription.Source == null)
                return false;
#if DEBUG
                return (System.IO.Path.GetDirectoryName(componentDescription.Source.Path) == System.IO.Path.GetDirectoryName(AppContext.BaseDirectory) + "\\ext"
        ...
        public static string[] InstalledComponentDirectories
        {
            get
            {
                return new string[]
                {
                    System.IO.Path.GetDirectoryName(AppContext.BaseDirectory) + "\\ext"
                };
            }
        }
