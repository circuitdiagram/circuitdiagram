...
//        private Dictionary<IPositionalElement, CircuitElementDrawingVisual> m_elementVisuals;
...
//        System.Windows.Point m_mouseDownPos;
...
//            {
//                if (Document != null)
//                    foreach (IPositionalElement element in Document.PositionalElements)
//                    {
...
//            {
//                foreach (IPositionalElement item in e.NewItems)
//                {
...
//                    }
//                }
//                m_selectedVisual.Offset = m_selectedComponents[0].Location.ToWinVector();
//            }
//        }
...
//                    }
//                }
//                m_selectedVisual.Offset = component.Location.ToWinVector();
//            }
//        }
...
//                dc.DrawRectangle(Brushes.White, null, new Rect(Document.Size.ToWinSize()));
...
//                        dc.DrawLine(pen, new System.Windows.Point(x, 0), new System.Windows.Point(x, this.height));
//                    }
...
//                            pen = new Pen(Brushes.LightGray, 1.5d);
//                        dc.DrawLine(pen, new System.Windows.Point(0, y), new System.Windows.Point(this.Width, y));
//                    }
//                }
...
//                        ComponentHelper.SizeComponent(m_tempComponent, m_mouseDownPos.ToCdPoint(), e.GetPosition(this).ToCdPoint());
//                        m_elementVisuals[m_tempComponent].Offset = m_tempComponent.Location.ToWinVector();
...
//                foreach (Component component in m_selectedComponents)
//                {
//                    m_originalOffsets.Add(component, component.Location.ToWinVector());
...
//                            dc.DrawEllipse(Brushes.Blue, new Pen(Brushes.Transparent, 0d), Point.Add(connection.Key, component.Location).ToWinPoint(), 2d, 2d);
//                    }
//                }
...
//                        dc.DrawEllipse(Brushes.Black, new Pen(Brushes.Black, 1d), connectionPoint.Key.ToWinPoint(), 3d, 3d);
...
//                            new Typeface("Arial"), 10d, Brushes.OrangeRed), connectionPoint.Key.ToWinPoint());
//                }
//            }
//        }
...
//                var offsetDelta = new Vector(mousePos.X - m_mouseDownPos.X, mousePos.Y - m_mouseDownPos.Y);

//                foreach (Component component in m_selectedComponents)
//                {
//                    var newOffset = Vector.Add(m_originalOffsets[component], offsetDelta);
...
//                        newOffset.X = ComponentHelper.Snap(new Primitives.Point(newOffset.X, newOffset.Y), ComponentHelper.GridSize).X;
//                    if (Math.IEEERemainder(newOffset.Y, 20d) != 0)
//                        newOffset.Y = ComponentHelper.Snap(new Primitives.Point(newOffset.X, newOffset.Y), ComponentHelper.GridSize).Y;
...
//                foreach (Component component in m_selectedComponents)
//                {
//                    (component as Component).Location = Vector.Add(m_originalOffsets[component], offsetDelta).ToCdVector();
//                    m_elementVisuals[component].Offset = component.Location.ToWinVector();
//                }
...
//                m_resizeVisual.Offset = m_resizingComponent.Location.ToWinVector();
//                using (DrawingContext dc = m_resizeVisual.RenderOpen())
//                {
//                    if (m_resizingComponent.Orientation == Orientation.Horizontal)
//                    {
...
//                m_elementVisuals[m_resizingComponent].Offset = m_resizingComponent.Location.ToWinVector();
//                m_elementVisuals[m_resizingComponent].UpdateVisual();
//                DrawConnections();
//            }
...
//                ComponentHelper.SizeComponent(newComponent, m_mouseDownPos.ToCdPoint(), e.GetPosition(this).ToCdPoint());
